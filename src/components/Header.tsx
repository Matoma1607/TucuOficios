        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {user ? (
            ...
            <button
              ...
              className="px-4 sm:px-6 py-2.5 bg-brand-primary text-white rounded-full font-bold hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100 active:scale-95 text-xs sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {isLoggingIn ? (
                <>
